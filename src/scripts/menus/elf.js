...
import { elfList } from "../../data/elfList.js";
...
function loadElfMenu() {
    ...
    searchBar.setAttribute("class", `searchBarElf`);
    searchBar.setAttribute("id", `searchBarElf`);
    searchBar.setAttribute("type", `text`);
    searchBar.setAttribute("placeholder", `Search...`);
    searchBar.addEventListener("keyup", function (e) {
        var input = document.getElementById("searchBarElf").value;
    ...
    buttonElfToMain.addEventListener("click", function (e) {
        var gameBox = document.getElementById("gameBox");
        gameBox.innerHTML = "";
        loadMainMenu();
    });
...
function scrollFill() {
    ...
    for (var i in elfList) {
        ...
        optionElf.style.background = `url('./src/images/elf/${elfList[i].title}.png') no-repeat center center fixed`;
